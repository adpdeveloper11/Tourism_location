...
public class SignIn_Activity extends AppCompatActivity {
    ...
    private Button btn_signin, btn_createuser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_createuser = (Button) findViewById(R.id.button_create);
                        ...
                        .addOnCompleteListener(SignIn_Activity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if(!task.isSuccessful()){
                                    ...
                                    Intent go = new Intent(SignIn_Activity.this,Main_Activity.class);
                                    startActivity(go);
                                    finish();
                                }
                            }
